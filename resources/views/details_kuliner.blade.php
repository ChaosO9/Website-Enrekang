        ...
        <section id="breadcrumbs" class="breadcrumbs">
            <div class="container" style="margin-top: 70px">
                <div class="d-flex justify-content-between align-items-center">
                    <h2 class="text-4xl">{{ $kuliner->nama_kuliner }}</h2>
                    <ol>
                        <li><a href="index.html">Home</a></li>
                        <li>Detail Kuliner</li>
                    </ol>
                </div>
                {{-- <br>{{ $kuliner->created_at }}</br> --}}
            </div>
                    ...
                    <div class="col-lg-8">
                        <div class="portfolio-details-slider swiper">
                            <div class="swiper-wrapper align-items-center">
                                <img src="{{ asset('images/kuliner/' . $kuliner->foto_kuliner) }}" alt="">
                            </div>
                        </div>
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel"
                                    ...
                                    <ul>
                                        ...
                                        <li><strong>Harga</strong>: Rp. {{ $kuliner->harga_kuliner }}</li>
                                        <li><strong>Lokasi</strong>: {{ $kuliner->alamat_kuliner }}</a></li>
                                        <li><strong>Deskripsi</strong>: <br> {{ $kuliner->deskripsi_kuliner }}</a></li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <li>
                                        <div class="container-2">
                                            ...
                                            <div class="star-widget">
                                                ...
                                                <form
                                                    action="{{ route('kuliner.tambah.review', ['id' => $kuliner->id]) }}"
        ...
        <section id="portfolio" class="portfolio mb-4">
            <div class="container">
                <div class="section-title ">
                    <h2>Review Kuliner {{ $kuliner->nama_kuliner }}</h2>
                </div>
                        ...
                        @foreach ($reviews as $ulasan)
                            <article class="mb-10">
                                ...
                                @if (isset($ulasan->gambar))
                                    <img src="{{ asset('images/kuliner/' . $ulasan->gambar) }}" alt="Description"
                ...
                {{-- <div class="col-lg-6 mt-5">
                    <iframe class="mb-4 mb-lg-0"
                        src="{{ 'https://www.google.com/maps/embed/v1/place?key=AIzaSyCtQdCKUA91HOI2QRMhKMNrZAxOQcOXWXM&q=' . $kuliner->maps }}"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form
                            action="{{ route('kuliner.tambah.gambar', ['id' => $kuliner->id, 'from' => 'detail_kuliner']) }}"
                            method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                    <div class="card shadow mb-4">
                                        <div class="card-header py-3">
                                            <h6 class="m-0 font-weight-bold text-primary">
                                                Tambah Gambar untuk Galeri Kuliner "{{ $kuliner->nama_kuliner }}"</h6>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="mb-3">
