                    ...
                    <div class="col-lg-8">
                        <div class="portfolio-details-slider swiper">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <img src="{{ asset('images/' . $kuliner->foto_kuliner) }}" alt="">
                            </div>
                            {{-- <img src="{{ asset('images/' . $item->foto_kuliner) }}" --}}
                            {{--
                                <div class="swiper-slide">
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            ...
                            <ul>
                                ...
                                {{-- <li><strong>Nama kuliner</strong>: {{$kuliner->nama_kuliner }}
                                        </li> --}}
                                <li><strong>Harga</strong>: {{ $kuliner->harga_kuliner }}</li>
        ...
        <section id="portfolio" class="portfolio">
            <div class="container">
                <div class="section-title ">
                    <h2>Galeri Kuliner {{ $kuliner->nama_kuliner }}</h2>
