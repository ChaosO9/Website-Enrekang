...
@section('contents')
    <form action="{{ route('penginapan.tambah.gambar', $penginapan->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">
                            Tambah Gambar untuk Galeri Penginapan "{{ $penginapan->nama_penginapan }}"</h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="mb-3">
